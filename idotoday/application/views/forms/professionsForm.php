...
<h2 class="font-bold">Share Your Best Skills</h2>
</div>
...
<div id="professionFormValidation">

</div>
<?php echo form_open('user/professions/add','id="professionsForm"'); ?>

 <input type="text" name="token" hidden value="<?php if(isset($_SESSION["profession_token"]))echo $_SESSION["profession_token"];?>">

 <input type="text" name="profession_id" value="" hidden>
...
<div class="form-group">
<input class="form-control" type="text" name="workplace" placeholder="Place of Work" required>
</div>
...
<input class="form-control" type="text" name="price" list="price" placeholder="Amount Charged">
  <datalist id="price">
...
<span class="col-form-label">per</span>
...
<input class="btn px-5 btn-info" type="submit" name="submit" id="addProfession" value="Add">

</div>

<div class="form-group row justify-content-center">

<input class="btn px-5 btn-info" type="submit" name="submit" id="updateProfession" value="Update" style="display: none;">
<button class="btn-link px-3 btn-info" type="button" id="newProfession" onclick="newProfessionbtn()" style="display: none;">New Profession</button>
</div>
